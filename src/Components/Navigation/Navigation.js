  ...
  const listen = onAuthStateChanged(auth, (user) => {
    if (user) {
      if (user.emailVerified) {
        ...
        dispatch({ type: "LOGIN", payload: {userName:user.displayName, email:user.email }});
      } else {
        ...
        <>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="mx-auto">
              ...
              <Nav.Link className="nav-point durjoy" as={Link} to="/class">
                Class 1-5
              </Nav.Link>
            ...
            <Nav className="ms-auto">
              <Nav.Link
                className="nav-point log-in-link"
        ...
        <>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="mx-auto">
              ...
              <Nav.Link className="nav-point durjoy" href="/class">
                Class 1-5
              </Nav.Link>
              <Nav.Link className="nav-point durjoy" href="/skills">
                Skills
              </Nav.Link>
              <Nav.Link className="nav-point durjoy" href="/kids">
                Kid's Corner
              </Nav.Link>
