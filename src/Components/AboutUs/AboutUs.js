    ...
    <div className="about-container">
      <Container className="aboutus-1">
        <div className="row-aboutus">
          <div>
            <img
              src="https://i.ibb.co/pbFMpsH/young-people-row-with-thumbs-up.jpg"
              alt=""
            />
          </div>
          <div>
            ...
            <h4 className="aboutus_text2">
              As three developers, we are working on creating an online course
            ...
            <Nav.Link as={Link} to="/aboutus">
              <button className="aboutus_btn">Read More</button>
            </Nav.Link>
          </div>
        </div>
      </Container>
